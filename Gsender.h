...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "c2VycmEuYXV0b21hdGljYUBnbWFpbC5jb20=";
        const char* EMAILBASE64_PASSWORD = "Rml3b2xkaW9pczAxJA==";
        const char* FROM = "serra.automatica@gmail.com";
